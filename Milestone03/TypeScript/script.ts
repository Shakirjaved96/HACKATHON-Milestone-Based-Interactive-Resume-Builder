document.addEventListener("DOMContentLoaded", () => {
    ...
    const skillsContent = document.getElementById(
        "skills-content"
    ) as HTMLElement;

    const toggleHobbiesButton = document.getElementById(
        "toggle-hobbies"
    ) as HTMLButtonElement;
    const hobbiesContent = document.getElementById(
        "hobbies-content"
    ) as HTMLElement;
